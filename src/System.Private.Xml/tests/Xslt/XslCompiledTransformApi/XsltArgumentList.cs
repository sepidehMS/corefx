...
namespace System.Xml.Tests
{
  ...
  <xsl:template match='/'>
    ...
    public class CArgGetExtObj : XsltApiTestCaseBase2
    {
        ...
        {
            string Baseline = "baseline" + Path.DirectorySeparatorChar + param;
            m_xsltArg = new XsltArgumentList();
    ...
    public class CArgAddExtObj : XsltApiTestCaseBase2
    {
        ...
        {
            string Baseline1 = "baseline" + Path.DirectorySeparatorChar + (string)param + "a.txt";
            string Baseline2 = "baseline" + Path.DirectorySeparatorChar + (string)param + "b.txt";
    ...
    public class CArgRemoveParam : XsltApiTestCaseBase2
    {
        ...
        public void RemoveParam1(object param)
        {
            ...
            _baseline = "baseline" + Path.DirectorySeparatorChar + (string)param;
            if ((LoadXSL("showParam.xsl") == 1) && (Transform_ArgList("fruits.xml") == 1))
            {
